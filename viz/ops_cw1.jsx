...
//
// Data source : ALEXIS_DATA.cw4  (dict from analytics/ops_cw1.py)
// Globals used from host: modColor, humanMod
// -----------------------------------------------------------------------

function CW4ChinaPipelineHealth({ data, color }) {
  if (!data || data.available === false) {
    return (
      <div style={{ padding:"24px 16px", fontFamily:"var(--fm)",
        fontSize:12, color:"var(--muted)", textAlign:"center" }}>
        No ChiCTR pipeline data available.
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      <div style={{ margin:"14px 12px 0", fontFamily:"var(--fm)", fontSize:9,
        ...
        All ChiCTR classifications are ML-derived. Thresholds: biologic
