...
function SQ1ModalityLandscape({ data, color }) {
  ...
  // SPARKLINE
  // ═══════════════════════════════════════════════════════════════════════
  const Sparkline = ({ history, width = 64, height = 24 }) => {
    ...
    const points = counts.map((c, i) =>
      `${(i / (counts.length - 1)) * width},${height - ((c - minC) / range) * (height - 2) - 1}`
    ).join(" ");
        ...
        <div
          ...
          <div>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:10, marginTop:8 }}>
              ...
              <Sparkline history={m.history} width={80} height={28} />
            </div>
          </div>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:8, marginTop:16 }}>
            <span style={{ fontFamily:"var(--fm)", fontSize:10, padding:"2px 8px",
              borderRadius:4,
              background: m.maturity === "early-heavy" ? "#60a5fa22"
                        : m.maturity === "late-heavy" ? "#fbbf2422" : "#6b728022",
              color: m.maturity === "early-heavy" ? "#60a5fa"
                   : m.maturity === "late-heavy" ? "#fbbf24" : "#6b7280" }}>
              {m.maturity === "early-heavy" ? "Early-stage heavy"
              : m.maturity === "late-heavy" ? "Late-stage heavy" : "Balanced pipeline"}
            </span>
