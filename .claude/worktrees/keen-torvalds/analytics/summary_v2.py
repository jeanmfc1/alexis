...
def drug_modality_provenance_summary(
    ...
    """
    Count how drug modality was derived using modality_source field.
    """
    counts = {
        "mesh": 0,
        "text_fallback": 0,
...
def drug_ta_provenance_summary(
    ...
    """
    Count how therapeutic area was derived using therapeutic_area_source field.
    """
    counts = {
        "mesh": 0,
        "text_fallback": 0,
