...
def reconstruct_trials(raw_trials: List[dict]) -> List[ClinicalTrialSignalV2]:
    ...
    for t in raw_trials:
        ...
        trial = ClinicalTrialSignalV2(
            ...
            therapeutic_area_source=t.get("therapeutic_area_source"),
